...
int main(void)
{
	...
	while ((c=getchar()!='Z')&&(i!=5))
	{
		...
		int typeOfScale=rand()%6;
		switch (typeOfScale)
		{
			case 0:
				{
					printf(" Harmonic Minor Scale (2 octaves,1 position) ");
					break;
				}
			case 1:
				{
                    printf(" Major Scale (1 octave,3 positions) ");
					break;
				}
			case 2:
				{
                    printf(" Pentatonic Minor  Scale (1 octave,5 positions) ");
					break;
				}
			case 3:
				{
                    printf(" Pentatonic Major Scale (2 octaves,3 positions) ");
					break;
				}
			case 4:
				{
                    printf(" Blues Scale (1 octave,5 positions) ");
					break;
				}
			case 5:
				{
                    printf(" Pentatonic Minor Scale in 5ths (1 octave,1 position) ");
					break;
				}
